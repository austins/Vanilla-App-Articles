        ...
        <li id="Article_<?php echo $Article->ArticleID; ?>" class="<?php echo $CssClass; ?>">
            ...
            <div class="ItemContent Article">
                ...
                <div class="Meta Meta-Article">
                    ...
                    ?>
                    <span class="MItem MCount ArticleCategory"><?php echo Anchor($Category->Name, ArticleCategoryUrl($Category)); ?></span>
                    <span class="MItem MCount ArticleDate"><?php echo Gdn_Format::Date($Article->DateInserted, '%e %B %Y - %l:%M %p'); ?></span>
